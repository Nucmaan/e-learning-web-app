  ...
  const courses = [
    {
      ...
      longDescription: 'This comprehensive course covers all aspects of digital marketing, from social media strategies to SEO optimization. You\'ll learn practical skills that can be immediately applied to improve your online presence and drive meaningful business results.',
      whatYouWillLearn: [
        'Develop an effective digital marketing strategy',
        'Optimize your website for search engines',
        'Create engaging social media campaigns',
        'Analyze marketing performance with key metrics',
        'Understand customer behavior online',
        'Implement cost-effective advertising techniques'
      ],
      curriculum: [
        {
          section: 'Introduction to Digital Marketing',
          lectures: ['The Digital Marketing Landscape', 'Setting Your Marketing Goals', 'Understanding Your Target Audience'],
          duration: '30 min'
        },
        {
          section: 'Content Marketing Fundamentals',
          lectures: ['Creating Valuable Content', 'Content Distribution Channels', 'Measuring Content Performance'],
          duration: '45 min'
        },
        {
          section: 'Social Media Marketing',
          lectures: ['Platform Selection Strategy', 'Creating Engaging Posts', 'Building Community'],
          duration: '45 min'
        }
      ]
    },
          ...
          <div className="relative h-72 w-full mb-8 rounded-lg overflow-hidden">
            <div className="w-full h-full bg-gray-200">
              ...
              <div className="w-full h-full flex items-center justify-center">
                <span className="text-xl font-bold text-gray-800">Course Preview Image</span>
              </div>
            </div>
          </div>
